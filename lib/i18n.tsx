...
const dicts: Record<Locale, Dict> = {
  en: {
    ...
    asyncEnrich: "Async enrich after save (faster)",
    ...
    styleShowcaseSubtitle: "Hover to explore.",
    styleShowcaseInstruction: "",
    ...
    mapSectionTitle: "Coordinates",
    mapSectionSubtitle: "Hover over the glowing points to explore.",
    mapEmptyCallout: "Hover over a glowing point to reveal the photographs from that location.",
    mapViewAll: "Explore {{count}} series",
    mapUnknownLocation: "Somewhere on Earth",
    mapUntitledSet: "Untitled collection",
    downGalleryTitle: "Galleries",
    downGallerySubtitle: "",
    search: "Search",
    ...
    optionsAutogenTitles: "Auto-fill set and picture title/subtitle translations",
  ...
  zh: {
    ...
    styleStreet: "街拍",
    styleTravel: "最近",
    styleShowcaseTitle: "专栏",
    styleShowcaseSubtitle: "悬停浏览，点击展开。",
    styleShowcaseInstruction: "",
    ...
    mapSectionTitle: "坐标",
    mapSectionSubtitle: "悬停地图上的光点，浏览对应作品。",
    mapEmptyCallout: "悬停地图上的光点，浏览该地点拍摄的作品。",
    ...
    optionsAutogenTitles: "为集合和图片标题/副标题自动补全中英文",
